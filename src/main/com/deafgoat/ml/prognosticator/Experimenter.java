...
public final class Experimenter {
     ...
     * 
     * @throws Exception
     *             If the model can not be created
     */
     ...
     * 
     * @param mode
     *            Indicatesif ARFF to be read is training (train) or testing
     *            (test) data
     * @throws Exception
     *             If data can not be split
     */
     ...
     * 
     * @throws Exception
     *             If ARFF data can not be created
     */
     ...
     * 
     * @throws Exception
     *             If ARFF writer can not be initialized
     */
     ...
     * 
     * @throws Exception
     *             If cross validation can not be performed
     */
    ...
    /**
     * Filters the supplied set of instances using a set of filters for our test
     * data.
     * 
     * @param instances
     *            The set of WEKA instances to be filtered
     * @return the set of filtered instances
     * @throws Exception
     *             If filter(s) can not be applied to data
     */
     ...
     * 
     * @throws IOException
     *             If application configuration can not be read
     * @throws JSONException
     *             If application configuration can not be parsed
     */
     ...
     * 
     * @param mode
     *            Indicates if ARFF to be read is training (train) or testing
     *            (test) data
     * @throws Exception
     ...
     * 
     * @param dataSet
     *            The WEKA instances object to split
     * @throws Exception
     *             If instances can not be split
     */
     ...
     * 
     * @throws Exception
     *             If instances can not be written to file
     */
    ...
    /**
     * @param configuration
     *            The location of the JSON configuration file to use
     * @throws IOException
     *             If JSON configuration file can not be read
     * @throws JSONException
     *             If JSON configuration file can not be parsed
     */
     ...
     * @throws IOException
     *             If JSON configuration file can not be found
     * @throws JSONException
     *             If JSON configuration file can not be parsed
     */
