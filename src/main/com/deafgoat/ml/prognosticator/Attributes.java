...
public final class Attributes {
     ...
     * 
     * @param attributeName
     *            The preferred name for this attribute
     * @param attributeType
     *            The WEKA type of this attribute
     * @param rawAttributeName
     *            The raw attribute name
     * @param include
     *            Indicates if this attribute is to be included in the ARFF file
     * @return The created attribute
     */
    public static Attributes createAttribute(String rawAttributeName, String attributeName, String attributeType,
            Boolean include) {
        return new Attributes(rawAttributeName, attributeName == null || attributeName.equals("") ? rawAttributeName
                : attributeName, attributeType, include);
    }
