...
public class MongoImport extends MongoMgr {
     ...
     */
    public JSONObject getConfiguration(String configName) throws FileNotFoundException, IOException, MongoException,
            JSONException {
     ...
     *             If it is unable to connect to a running mongod.
     */
    public boolean removeConfiguration(String configName) throws FileNotFoundException, IOException, MongoException,
            JSONException {
