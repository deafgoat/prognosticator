...
public class MongoIntTests {
    ...
    @Test
    public final void testPreConfigurationCount() throws JSONException, FileNotFoundException, MongoException,
            IOException {
        _mongoExport.writeJSON();
    ...
    @Test
    public final void testPostConfigurationCount() throws JSONException, FileNotFoundException, MongoException,
            IOException {
        ArrayList<JSONObject> configurations = _mongoImport.getAllConfigurations();
